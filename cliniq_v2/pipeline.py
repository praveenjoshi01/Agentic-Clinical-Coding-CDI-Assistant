"""
End-to-end pipeline orchestrator for cliniq_v2.
...
This is the cliniq_v2 variant: all module imports point to cliniq_v2.modules
(backed by OpenAI GPT-4o) instead of cliniq.modules (backed by local OSS models).
The API surface (function signatures, return types) is identical to cliniq.pipeline.
"""
